...
//   document.querySelector('.firework').appendChild(canvas);`
//   canvas.id='firework'
...
function loop() {
  ...
  if (SCREEN_WIDTH != document.documentElement.clientWidth) {
    canvas.width = SCREEN_WIDTH = document.documentElement.clientWidth;
  }
  if (SCREEN_HEIGHT != document.documentElement.clientHeight) {
    canvas.height = SCREEN_HEIGHT = document.documentElement.clientHeight;
  }
  // clear canvas
...
function initFirework() {
  ...
  intervalLaunch=setInterval(launch, 300);
  intervalLoop=setInterval(loop, 1000 /60);
}
function clearFirework() {
  document.querySelector('.firework').removeChild(canvas)
